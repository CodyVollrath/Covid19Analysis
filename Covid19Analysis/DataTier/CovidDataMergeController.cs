...
namespace Covid19Analysis.DataTier
{
    ...
    public class CovidDataMergeController
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <a onclick="return false;" href="CovidDataMergeController" originaltag="see">CovidDataMergeController</a> class.
        ...
        /// <Summary>Gets the duplicate records that are found.
